                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: SingleChildScrollView(
                        ...
                        physics: scroll.isFocused.value ? BouncingScrollPhysics() : NeverScrollableScrollPhysics(),
                          ...
                          child: Center(
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Visibility(visible: screenHeight < 1000, child: SizedBox(height: 40.h)),
                                  // 이메일 TextField
                                  SizedBox(
                                    height: 50.h,
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        enabledBorder: OutlineInputBorder(
                                          borderSide: BorderSide(color: mTextField, width: 2),
                                        ...
                                        prefixIcon: Padding(
                                          ...
                                          child: Image.asset('assets/images/icon/login_id.png'),
                                        ),
                                      ),
                                    ...
                                    return SizedBox(
                                      ...
                                      child: TextField(
                                        ...
                                        decoration: InputDecoration(
                                          ...
                                          focusedBorder: OutlineInputBorder(
                                            borderSide: BorderSide(color: mFontYellow, width: 2.w),
                                            borderRadius: BorderRadius.all(Radius.circular(50.r)),
                                          ),
                                          fillColor: mBackWhite,
                                          prefixIcon: Padding(
                                            padding: EdgeInsets.all(gapSmall),
                                            child: Image.asset('assets/images/icon/login_pw.png'),
                                          ),
                                  ...
                                  Obx(
                                    () {
                                      return SwitchListTile(
                                        title: Text(
                                          '자동로그인 켜기',
                                          style: TextStyle(color: mFontSub, fontSize: 12.sp),
                                        ),
                                        activeColor: Colors.green,
                                        value: autoLoginCheckController.isChecked.value,
                                        onChanged: (value) {
                                          setState(() {
                                            autoLoginCheckController.updateCheck(value);
                                          });
                                        },
                                      );
                                    },
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                      width: double.infinity,
                                      height: 50.0.h,
                                      decoration: BoxDecoration(color: Color(0xFF3D925C), borderRadius: BorderRadius.circular(50.sp)),
                                      child: Padding(
